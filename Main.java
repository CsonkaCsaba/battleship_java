...
class Main {
    public static void main(String[] args) {
        ...
        //Placement of ships
        System.out.println("Welcome " + player1_Name + "! Please enter the first cells' coordinate of the given sized ships in the next few steps!\nNote that horizontal means left to right, while vertical means up to bottom directions!");
        ...
        for(int k = 0; k < shipsToPlace.length; k++){
            ...
            ships_player1.add(new Ship(shipsToPlace[k],row,col,orient));
        ...
        Player player1 = new Player(player1_Name, ships_player1);
        player1.inicializeValues();
        player1.showTable();
